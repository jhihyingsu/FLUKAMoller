...
*
      ...
      PARAMETER (RMAX = 75.0)
      PARAMETER (PhiMIN = -25.71429)
      PARAMETER (PhiMAX = 25.71429)
...
*     gradient in tesla per cm
         GRADIENT = 0.08D+00  
         INDEX = 1
         OPEN(UNIT=17, FILE ='/home/jysu/MOLLER-hallA/V2U_c.txt')
*         LUNRD = NINT(WHASOU(1))
         DO I = 1, NR2
            DO  J = 1, NPHI
               DO  K = 1, NZ2
         ...
         END DO
         INDEX = 1
         OPEN(UNIT=18, FILE ='/home/jysu/MOLLER-hallA/V2D_c.txt')
*         LUNRD = NINT(WHASOU(1))
         DO I = 1, NR
            DO  J = 1, NPHI
               DO  K = 1, NZ
...
*               WRITE(LUNOUT,*) 'FX', FX, ' FY', FY, ' FZ', FZ
               P111 = (PHI+NSEC*360/TOTSEC)/180*3.1416
